...
//           <div className="mt-3">
//             <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Export Dashboard</h3>
...
//                 disabled={isExporting}
//                 className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:bg-gray-900 disabled:opacity-50"
//               >
...
//                 <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Schedule Report</h4>
//                 <div className="space-y-2">
//                   <button
//                     onClick={() => scheduleReport({ frequency: 'weekly', recipients: ['user@example.com'] })}
//                     className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-800 rounded"
//                   >
//                     Weekly Report
//                   </button>
//                   <button
...
//               className="inline-flex items-center px-3 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
//             >
