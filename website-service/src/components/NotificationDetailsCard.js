      ...
      <div className="mt-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <div className="space-y-1 text-xs">
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium text-gray-900 dark:text-gray-100">{taskData.projectName}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-600 dark:text-gray-300">Content:</span>
            <span className="font-medium text-gray-900 dark:text-gray-100">{notification.message}</span>
          </div>
          {/* <div className="flex items-center justify-between">
            <span className="text-gray-600 dark:text-gray-300">Assigned by:</span>
            <span className="font-medium text-gray-900 dark:text-gray-100">{notification.teamLeadName || taskData?.assignedBy}</span>
          </div> */}
          {taskData?.dueDate && (
            <div className="flex items-center justify-between">
              <span className="text-gray-600 dark:text-gray-300">Due date:</span>
              <span className="font-medium text-gray-900 dark:text-gray-100">{taskData.dueDate}</span>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="space-y-2">
          {reviewData?.projectName && (
            <div className="text-xs">
              <span className="text-gray-600 dark:text-gray-300">Project: </span>
              <span className="font-medium text-gray-900 dark:text-gray-100">{reviewData.projectName}</span>
            </div>
          )}
          
          {reviewData?.reviewedBy && (
            <div className="text-xs">
              <span className="text-gray-600 dark:text-gray-300">Reviewed by: </span>
              <span className="font-medium text-gray-900 dark:text-gray-100">{reviewData.reviewedBy}</span>
            </div>
          )}

          {reviewData?.newTaskStatus && (
            <div className="text-xs">
              <span className="text-gray-600 dark:text-gray-300">New Status: </span>
  ...
  if (notification.project) {
    return (
      <div className="mt-2 p-2 bg-white dark:bg-gray-800 rounded border">
        <p className="text-xs font-medium text-gray-600 dark:text-gray-300">Project:</p>
        <p className="text-sm text-gray-900 dark:text-gray-100">{notification.project.name}</p>
