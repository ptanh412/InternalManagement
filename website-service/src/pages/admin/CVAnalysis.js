        ...
        <div className="mb-4">
          ...
          {isEditing ? (
            ...
            <div className="flex items-start space-x-2 group">
              <p className="flex-1 text-gray-900 dark:text-gray-100">{value || 'N/A'}</p>
              <button
                onClick={() => setIsEditing(true)}
                className="p-1 text-gray-400 dark:text-gray-500 hover:text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity"
              >
    ...
    return (
      <div className="space-y-3">
        {Object.entries(skills).map(([skillName, proficiency]) => (
          <div key={skillName} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg group">
            {editingSkill === skillName ? (
              ...
              <>
                <div className="flex-1">
                  <div className="flex items-center space-x-2">
                    <span className="font-medium text-gray-900 dark:text-gray-100">{skillName}</span>
                  ...
                  <div className="flex items-center space-x-4 mt-1">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-300">{skillExperience[skillName]} years</span>
                  </div>
                </div>
...
const ResultModal = ({ 
  ...
  roles, 
  onClose, 
  onCreateProfile, // Hàm này sẽ được gọi ở component cha
  uploadLoading 
}) => {
  // React Hooks must be called before any early returns
    ...
    if (!isOpen || !editingResult) return null;
  ...
  //       return;
  //     }
  //       console.log('🚀 Creating user profile with request:', userCreationRequest);
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between p-6 border-b">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">CV Analysis Result</h2>
            ...
            <button
              onClick={onClose}
              className="p-2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-800 rounded-lg"
            >
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div>
                    ...
                    {/* <select
                      value={editingResult.businessMappings?.departmentId || ''}
                      onChange={(e) => updateBusinessMapping('departmentId', e.target.value)}
                      className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-800"
                    >
                  ...
                  <div>
                    ...
                    <CustomSelect
                      ...
                      options={positions
                        ...
                        .map(pos => ({ value: pos.id, label: `${pos.title} (${pos.seniorityLevel})` }))}
                  ...
                  <div>
                    ...
                    <CustomSelect
                      ...
                      options={roles.map(role => ({ value: role.id, label: `${role.name} - ${role.description}` }))}
                  ...
                  {profile.workHistory?.map((exp, idx) => (
                    <div key={idx} className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                      <div className="flex justify-between items-start">
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{exp.startDate} - {exp.endDate}</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-3">
                  {profile.education?.map((edu, idx) => (
                    <div key={idx} className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">{edu.institution} • {edu.graduationYear}</p>
                      {edu.gpa && <p className="text-sm text-gray-600 dark:text-gray-300">GPA: {edu.gpa}</p>}
                    </div>
                  ))}
                </div>
              </section>
        ...
        <div className="p-6 border-t bg-gray-50 dark:bg-gray-900 flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            <button
              onClick={onClose}
              className="px-6 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-800"
            >
              Cancel
            </button>
            <button
...
const CVAnalysis = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-2">Please make sure you are logged in</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 p-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">CV Analysis with AI</h2>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Upload CV for Analysis</h3>
        ...
        >
          ...
          <div className="mb-4">
            ...
            <span className="text-gray-500 dark:text-gray-400 dark:text-gray-500"> or drag and drop</span>
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">PDF, DOC, DOCX files up to 10MB</p>
        </div>

        {selectedFiles.length > 0 && (
          <div className="mt-4">
            <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Selected File:</h4>
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Total Analyzed</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">{stats.totalAnalyzed}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">All time</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Users Created</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">{stats.totalUsersCreated}</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">AI accuracy</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Pending/Failed</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Analysis History</h3>
            <div className="flex items-center space-x-3">
              ...
              {/* <select
                ...
                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
          </div>
                ...
                <tr>
                  <td colSpan="6" className="px-6 py-12 text-center">
                    <div className="flex justify-center items-center space-x-2">
                      ...
                      <span className="text-gray-500 dark:text-gray-400 dark:text-gray-500">Loading history...</span>
                    </div>
                  </td>
                </tr>
                    ...
                    <td className="px-6 py-4">
                      {item.extractedName ? (
                        <div className="text-sm">
                          <div className="font-medium text-gray-900 dark:text-gray-100">{item.extractedName}</div>
                          <div className="text-gray-500 dark:text-gray-400 dark:text-gray-500">{item.extractedEmail}</div>
                          <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                            {item.extractedDepartment} • {item.extractedSeniority} • {item.totalSkills} skills
                          </div>
                        </div>
                      ) : (
                        <span className="text-sm text-gray-400 dark:text-gray-500">No data extracted</span>
                      )}
                    </td>
                    <td className="px-6 py-4">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Analysis Details</h3>
              <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">File Information</h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-gray-600 dark:text-gray-300">File Name:</span>
                    <p className="font-medium text-gray-900 dark:text-gray-100 mt-1">{selectedHistory.fileName}</p>
                  </div>
                  <div>
                    <span className="text-gray-600 dark:text-gray-300">File Size:</span>
                    <p className="font-medium text-gray-900 dark:text-gray-100 mt-1">{formatFileSize(selectedHistory.fileSize)}</p>
                  </div>
                  <div>
              ...
              {selectedHistory.extractedName && (
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">Extracted Information</h4>
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center">
                      <UserIcon className="h-5 w-5 text-blue-600 mr-2" />
                      <div>
                        <span className="text-gray-600 dark:text-gray-300">Name:</span>
                        <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{selectedHistory.extractedName}</span>
                      </div>
                    </div>
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{selectedHistory.extractedEmail}</span>
                      </div>
                    </div>
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{selectedHistory.extractedPhone}</span>
                      </div>
                    </div>
                    <div className="flex items-center">
                      ...
                      <div>
                        <span className="text-gray-600 dark:text-gray-300">Department:</span>
                        <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{selectedHistory.extractedDepartment}</span>
                        <span className="text-gray-600 dark:text-gray-300 ml-2">•</span>
                        <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{selectedHistory.extractedSeniority}</span>
                      </div>
                    </div>
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{selectedHistory.totalSkills} skills identified</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {selectedHistory.createdUsername && (
                <div className="bg-green-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">User Created</h4>
                  <div className="space-y-2 text-sm">
                    <div>
                      <span className="text-gray-600 dark:text-gray-300">Username:</span>
                      <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{selectedHistory.createdUsername}</span>
                    </div>
                    <div>
                      <span className="text-gray-600 dark:text-gray-300">Created At:</span>
                      <span className="font-medium text-gray-900 dark:text-gray-100 ml-2">{formatDate(selectedHistory.userCreatedAt)}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="border-l-2 border-gray-200 dark:border-gray-700 pl-4 space-y-4">
                <div className="relative">
                  ...
                  <div className="text-sm">
                    <p className="font-medium text-gray-900 dark:text-gray-100">CV Analyzed</p>
                    <p className="text-gray-600 dark:text-gray-300">{formatDate(selectedHistory.analyzedAt)}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">Processing time: {selectedHistory.processingTimeMs}ms</p>
                  </div>
                </div>
                ...
                {selectedHistory.userCreatedAt && (
                  <div className="relative">
                    ...
                    <div className="text-sm">
                      <p className="font-medium text-gray-900 dark:text-gray-100">User Profile Created</p>
                      <p className="text-gray-600 dark:text-gray-300">{formatDate(selectedHistory.userCreatedAt)}</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">Username: {selectedHistory.createdUsername}</p>
                    </div>
                  </div>
                )}
              </div>
      ...
      {/* Features Overview */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">AI-Powered Features</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg">
            <DocumentTextIcon className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
            <div>
              <h4 className="font-medium text-gray-900 dark:text-gray-100">Smart Parsing</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Extract structured data from any CV format</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Intelligent skill extraction and proficiency scoring</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 p-4 bg-purple-50 rounded-lg">
            <PencilIcon className="h-6 w-6 text-purple-600 mt-1 flex-shrink-0" />
            <div>
              <h4 className="font-medium text-gray-900 dark:text-gray-100">Edit Results</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Review and modify extracted information</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 p-4 bg-orange-50 rounded-lg">
            <UserPlusIcon className="h-6 w-6 text-orange-600 mt-1 flex-shrink-0" />
            <div>
              <h4 className="font-medium text-gray-900 dark:text-gray-100">Auto Profile</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Create user profiles with one click</p>
            </div>
          </div>
        </div>
      </div>
