...
class AIService {
  ...
  async generateTaskRecommendations(taskId) {
    try {
      const response = await httpClient.post(
        `${AI_SERVICE_BASE_URL}/ai/recommendations/task/${taskId}`
      );
      return response.data;
    } catch (error) {
  ...
  async generateEmergencyRecommendations(taskId) {
    try {
      const response = await httpClient.post(
        `${AI_SERVICE_BASE_URL}/ai/recommendations/task/${taskId}/emergency`
      );
      return response.data;
    } catch (error) {
  ...
  async generateTeamRecommendations(taskId, teamId) {
    try {
      const response = await httpClient.post(
        `${AI_SERVICE_BASE_URL}/ai/recommendations/task/${taskId}/team/${teamId}`
      );
      return response.data;
    } catch (error) {
  ...
  async checkRecommendationServiceHealth() {
    try {
      const response = await httpClient.get(
        `${AI_SERVICE_BASE_URL}/ai/recommendations/health`
      );
      return response.data;
    } catch (error) {
