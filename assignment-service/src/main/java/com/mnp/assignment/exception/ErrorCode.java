package com.mnp.assignment.exception;
...
public enum ErrorCode {
    ...
    ASSIGNMENT_NOT_FOUND(1019, "Assignment not found", HttpStatus.NOT_FOUND),
    ASSIGNMENT_ALREADY_EXISTS(1020, "Assignment already exists", HttpStatus.BAD_REQUEST),
    INVALID_TASK_ID(1021, "Task ID is required", HttpStatus.BAD_REQUEST),
    INVALID_USER_ID(1022, "User ID is required", HttpStatus.BAD_REQUEST),
    REASSIGNMENT_REASON_REQUIRED(1023, "Reassignment reason is required", HttpStatus.BAD_REQUEST),
