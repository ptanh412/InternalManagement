package com.mnp.project.exception;
...
public enum ErrorCode {
    ...
    PROJECT_NOT_EXISTED(1019, "Project not found", HttpStatus.NOT_FOUND),
    CHAT_GROUP_CREATION_FAILED(1020, "Chat group creation failed", HttpStatus.INTERNAL_SERVER_ERROR),
    ;
